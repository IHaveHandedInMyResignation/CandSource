		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<div class="row">
					...
					<!-- ************************************* -->
					<div class="col-sm-5">
						<div class="well well-sm tasks">
							<a
								href="${pageContext.request.contextPath}/taskmgr/upcoming?page=1"
								title="Click to manage your Upcoming Tasks">Upcoming Tasks:</a>
							<p></p>
							<ul class="list-group">
								...
								<c:forEach items="${upcomingTasks}" var="upcomingTask">
									<form:form method="GET" action="edit">
										<li class="list-group-item"><input type="hidden"
											name="id" id="id" value="${upcomingTask.id}" />
											<p>
					...
					<form:form modelAttribute="personalTask" method="POST"
						action="${pageContext.request.contextPath}/taskmgr/add">
								...
								<div class="form-group">
									<div class="text-left">
										...
										<form:textarea path="description" rows="3"
											class="form-control" maxlength="65"></form:textarea>
										<label>Full Description:</label>
										<form:textarea path="fullText" rows="6" class="form-control"
									...
									<div class="row" id="dateHeader">
										<div class="col-sm-11">
											<span class="label label-info"></span><label>Start
												Date&Time:</label>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												<form:input path="startDate" type="datetime"
									...
									<div class="row" id="dateHeader">
										<div class="col-sm-11">
											<span id="optionaLabel" class="label label-info">(Optional)</span><label>
									...
									<div class="row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												<form:input path="reminderDate" type="datetime"
									...
									<div class="row">
										...
										<div class="col-sm-10">
											<div class="input-group">
												<form:input path="finishDate" type="datetime"
									...
									<div class="checkbox">
										<label><form:checkbox path="active" value=""
												checked="checked"></form:checkbox>Activated</label>
									</div>
			...
			<div class="col-sm-3 well well-sm tasks">
				<p>
					<a href="${pageContext.request.contextPath}/taskmgr/past?page=1"
						title="Click to manage your past tasks">Your past tasks:</a>
				</p>
