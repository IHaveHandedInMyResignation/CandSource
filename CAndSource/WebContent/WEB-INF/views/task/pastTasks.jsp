...
<body>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="row">
					...
					<div class="col-sm-6">
							<h4 title="Click to manage your Past Tasks">
							...
							<ul class="list-group">
								<c:forEach items="${pastTasks}" var="pastTask">
									<li class="list-group-item">
										...
										<p id="taskDate">
											<span class="label label-danger">${f:formatLocalDateTime(pastTask.startDate, 'dd-MM-yyyy')}</span>
											<span class="label label-danger">${f:formatLocalDateTime(pastTask.startDate, 'hh:mm')}</span>
										</p>
									</li>
								</c:forEach>
							</ul>
	...
	<footer class="navbar navbar-fixed-bottom">
		<div class="container text-center">
			<a
				href="${pageContext.request.contextPath}/taskmgr/past?page=${pageNum lt 2 ? 1: pageNum-1}"
				id="footerBtn" class="btn btn-link"> <span
				class="glyphicon glyphicon-minus"></span><strong> 5</strong></a> <a
				href="${pageContext.request.contextPath}/taskmgr/past?page=${pageNum +1}"
				id="footerBtn" class="btn btn-link"><span
