...
<body>
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
			<li><a href="${pageContext.request.contextPath}/expenses/">New
					Receipt</a></li>
			<li class="active"><a
				href="${pageContext.request.contextPath}/expenses/view">Expenses
					view</a></li>
		</ul>
		<br>
								...
								<div class="text-right">
									<div class="input-group">
										<form:input path="date" type="datetime"
											...
											class="input-sm form-control" readonly="true"></form:input>
