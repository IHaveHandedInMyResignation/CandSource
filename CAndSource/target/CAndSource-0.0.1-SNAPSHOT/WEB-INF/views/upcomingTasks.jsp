...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="well well-sm">
							<a href="#" title="Click to manage your Upcoming Tasks">Upcoming
								Tasks:</a>
							<p></p>
							<ul class="list-group">
	...
	<footer class="navbar navbar-fixed-bottom">
		<div class="container text-center">
			<a href="${pageContext.request.contextPath}/taskmgr/upcoming?page=${pageNum lt 2 ? 1: pageNum-1}" id ="footerBtn" class="btn btn-link"> <span class="glyphicon glyphicon-minus"></span><strong> 5</strong></a>
			<a href="${pageContext.request.contextPath}/taskmgr/upcoming?page=${pageNum +1}" id ="footerBtn" class="btn btn-link"><span class="glyphicon glyphicon glyphicon-plus"></span><strong> 5</strong> </a>
		</div>
	</footer>
