...
<body>
	...
	<div class="container">
		...
		<br>
		<form:form modelAttribute="expense" method="POST" readonly="readonly"
			action="price/added/">
				...
				<div class="col-sm-6">
					<div class="well">
						<div class="row">
							<div class="col-sm-6">
								<p>Type:</p>
								<form:input path="type" type="text" class="form-control" readonly="true"></form:input>

								<p>Price:</p>
								<form:input path="cost" type="number" class="form-control"
									maxlength="10" onkeypress="return isNumberKey(event)" readonly="true"></form:input>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								...
								<form:textarea path="description" rows="3" class="form-control"
									maxlength="1000" readonly="true" ></form:textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="text-right">
									<div class="input-group">
										    <form:input path="date" type="datetime" id="finishDateTimePicker" name="search_message[displayDateFrom]" placeholder="YYYY-MM-DD hh:mm:ss" class="input-sm form-control" readonly="true"></form:input>
